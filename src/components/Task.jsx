...
export const Task = () => {
  return (
    <div className="py-2 px-4 bg-neutral-900 md:pt-4 md:px-12">
      <div className="flex items-center gap-3 md:gap-2 pb-2 mb-4 sticky top-11 bg-neutral-900 md:bg-transparent md:pt-2 md:top-0 md:backdrop-blur-md z-20">
      ...
      <div className="modal">
        <div className="modal-box bg-neutral-800">
          ...
          <input
            ...
            name="title"
            placeholder="Title"
            className="input input-bordered w-full mt-2 focus:outline-none focus:scale-100 bg-neutral-800"
            required
          />
          <input
            type="datetime-local"
          ...
          <select
            name="category"
            className="select select-bordered w-full mt-2 focus:outline-none focus:scale-100 bg-neutral-800"
          >
